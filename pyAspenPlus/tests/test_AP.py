...
try:
    ...
    # 將pyAspenPlus包添加至路徑當中，不然沒辦法import
    package_path = os.path.abspath('..\\..')
    sys.path.append(package_path)
    import pyAspenPlus

path = os.path.join(os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe()))),  # 當前檔案之目錄
                    "test_file", "DistillationColumn.apw")
print(path)
